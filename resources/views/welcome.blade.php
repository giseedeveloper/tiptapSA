...
<head>
    ...
    <style>
        ...
        #site-nav.scrolled {
            box-shadow: 0 4px 24px rgba(18,20,28,0.08);
        }
        .btn-glow {
        ...
        .pricing-billing-btn.is-active {
            background: #fff;
            color: #6D52E8;
            box-shadow: 0 4px 14px rgba(109,82,232,0.15);
        }
        .testimonial-card {
            background: #fff;
            border: 1px solid rgba(18,20,28,0.06);
        ...
        .testimonial-card:hover {
            ...
            box-shadow: 0 16px 40px rgba(109,82,232,0.1);
        }
        ...
        .hero-trust-bar {
            ...
            box-shadow: 0 10px 32px rgba(18,20,28,0.06), 0 0 0 1px rgba(140,113,246,0.06);
        }
