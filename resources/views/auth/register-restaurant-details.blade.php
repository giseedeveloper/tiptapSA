<x-guest-layout title="TIPTAP | Restaurant Details" :hero-background="true" :wide="true">
    <div class="max-w-xl mx-auto">
        ...
        <form method="POST" action="{{ route('restaurant.register.details.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input id="phone" name="phone" type="tel" value="{{ old('phone') }}" required placeholder="e.g. 082 123 4567"
                       class="block w-full px-4 py-3.5 bg-[#F5F3FF] border border-[#DDD7FE] rounded-xl font-medium text-[#12141C] focus:ring-2 focus:ring-[#8C71F6] focus:border-transparent">
            ...
            <div>
                ...
                <input id="location" name="location" type="text" value="{{ old('location') }}" required placeholder="e.g. Sandton, Johannesburg"
                       class="block w-full px-4 py-3.5 bg-[#F5F3FF] border border-[#DDD7FE] rounded-xl font-medium text-[#12141C] focus:ring-2 focus:ring-[#8C71F6] focus:border-transparent">
